...
public static class TitheTables
{
    ...
    [
      { "id": "archer",  "name": "Archer",  "policy": "skirmisher", "passive": "long_shot", "element": "air", "baseHp": 26, "ap": 6, "mp": 4,
        ...
        "skills": ["piercing_shot", "crippling_arrow", "deadeye", "barbed_quill", "hawk_eye", "pinning_shot", "scatter_volley"], "blurb": "An Air archer: keeps max distance, shoots the softest target; Long Shot hits harder from afar. Agility is its damage." },
      { "id": "bulwark", "name": "Bulwark", "policy": "bruiser", "passive": "rage_below", "element": "earth", "baseHp": 48, "ap": 6, "mp": 3,
        ...
        "skills": ["slam", "seize", "bastion", "blood_price", "gravecall", "martyr_oath", "blood_leap"], "blurb": "An Earth bulwark: advances, body-blocks, shoves with Slam; Rage Below hits harder when bloodied. Strength is its damage." },
      { "id": "cannon",  "name": "Cannon",  "policy": "artillery", "passive": "overchannel", "element": "fire", "baseHp": 34, "ap": 7, "mp": 3,
        ...
        "skills": ["ruin_bolt", "flashfire", "blood_pact", "backblast", "iron_will", "war_cry", "sunder"], "blurb": "A Fire cannon: holds a sightline and nukes; Overchannel banks its unspent AP into the hit. Intelligence is its damage." }
    ]
    """;
    ...
    [
      ...
      { "id": "bone_piper",    "name": "Bone Piper",    "policy": "support", "maxHp": 26, "ap": 6, "mp": 3,
        ...
        "skills": ["piper_gift", "piper_mend", "piper_call"], "xp": 145, "stones": 24, "essence": "Piper's Mend", "drop": 8, "gear": 5 },
      ...
      { "id": "sexton",        "name": "The Sexton",    "policy": "melee",   "maxHp": 150, "ap": 8, "mp": 2,
        "strength": 22, "agility": 6,  "initiative": 7,  "skills": ["sexton_smash", "sexton_hook", "husk_strike", "wraith_toll"], "xp": 700, "stones": 120,
    ...
    [
      { "key": "piercing_shot", "name": "Piercing Shot", "ap": 4, "min": 4, "max": 8, "crit": 30, "los": true,
        "ranks": [ { "min": 3 }, { "max": 9, "crit": 22 } ],
        "effects": [ { "kind": "damage", "element": "air", "min": 11, "max": 16 } ] },
      { "key": "slam", "name": "Slam", "ap": 4, "min": 1, "max": 1, "crit": 28, "los": true,
        "ranks": [ { "max": 2 }, { "ap": 3, "crit": 20 } ],
        "effects": [ { "kind": "damage", "element": "earth", "min": 12, "max": 18 }, { "kind": "push", "cells": 2 } ] },
      { "key": "ruin_bolt", "name": "Ruin Bolt", "ap": 4, "min": 3, "max": 6, "crit": 30, "los": true,
        "ranks": [ { "max": 7 }, { "ap": 3, "crit": 22 } ],
        "effects": [ { "kind": "damage", "element": "fire", "min": 18, "max": 24 } ] },
      { "key": "barbed_quill", "name": "Barbed Quill", "ap": 3, "min": 4, "max": 7, "crit": 32, "los": true, "cooldown": 1,
        "ranks": [ { "max": 8 }, { "cooldown": 0, "crit": 24 } ],
      ...
      { "key": "backblast", "name": "Backblast", "ap": 3, "min": 1, "max": 3, "crit": 30, "los": true, "cooldown": 1,
        "ranks": [ { "max": 4 }, { "ap": 2, "crit": 22 } ],
        "effects": [ { "kind": "damage", "element": "fire", "min": 10, "max": 15 }, { "kind": "push", "cells": 2 } ] },
      { "key": "husk_strike", "name": "Husk Strike", "ap": 3, "min": 1, "max": 1, "crit": 35, "los": true,
        "effects": [ { "kind": "damage", "element": "earth", "min": 12, "max": 18 } ] },
      { "key": "marrow_spit", "name": "Marrow Spit", "ap": 3, "min": 3, "max": 6, "crit": 35, "los": true,
        "effects": [ { "kind": "damage", "element": "water", "min": 10, "max": 15 } ] },
      { "key": "grave_bite", "name": "Grave Bite", "ap": 3, "min": 1, "max": 1, "crit": 30, "los": true,
      ...
      { "key": "mite_sap", "name": "Sap", "ap": 2, "min": 1, "max": 1, "crit": 35, "los": true,
        "effects": [ { "kind": "damage", "element": "air", "min": 4, "max": 7 }, { "kind": "status", "status": "mpdrain", "mag": 1, "turns": 1 } ] },
      { "key": "piper_mend", "name": "Piper's Mend", "ap": 3, "min": 1, "max": 5, "los": true, "cooldown": 2,
        "effects": [ { "kind": "heal", "min": 10, "max": 16 } ] },
      { "key": "piper_call", "name": "Piper's Call", "ap": 4, "min": 1, "max": 3, "los": false, "cooldown": 4, "targetsGround": true,
        "effects": [ { "kind": "summon", "summon": "grave_mite" } ] },
      { "key": "wraith_toll", "name": "Wraith's Toll", "ap": 4, "min": 2, "max": 6, "crit": 30, "los": true, "cooldown": 3,
        "effects": [ { "kind": "damage", "element": "air", "min": 5, "max": 8 }, { "kind": "steal_ap", "min": 1, "turns": 2 } ] },
      { "key": "mend_self", "name": "Field Dressing", "ap": 3, "min": 0, "max": 0, "los": false, "cooldown": 3,
        "effects": [ { "kind": "heal", "min": 12, "max": 18 } ] },
      { "key": "hawk_eye", "name": "Hawk's Eye", "ap": 2, "min": 0, "max": 0, "los": false, "cooldown": 4,
        "ranks": [ { "cooldown": 3 }, { "ap": 1 } ],
        "effects": [ { "kind": "status", "status": "rangebuff", "mag": 2, "turns": 3 } ] },
      { "key": "pinning_shot", "name": "Pinning Shot", "ap": 3, "min": 2, "max": 6, "crit": 30, "los": true, "cooldown": 3,
        "ranks": [ { "max": 7 }, { "cooldown": 2 } ],
        "effects": [ { "kind": "damage", "element": "air", "min": 7, "max": 11 }, { "kind": "status", "status": "rooted", "mag": 1, "turns": 1 } ] },
      { "key": "scatter_volley", "name": "Scatter Volley", "ap": 4, "min": 3, "max": 7, "crit": 32, "los": true, "cooldown": 2,
        "ranks": [ { "max": 8 }, { "cooldown": 1 } ],
        "effects": [ { "kind": "damage", "element": "air", "min": 9, "max": 13 } ] },
      { "key": "blood_leap", "name": "Blood Leap", "ap": 3, "min": 1, "max": 4, "los": false, "cooldown": 3, "targetsGround": true,
        "ranks": [ { "max": 5 }, { "cooldown": 2 } ],
        "effects": [ { "kind": "teleport" } ] },
      { "key": "gravecall", "name": "Gravecall", "ap": 3, "min": 2, "max": 5, "crit": 28, "los": true, "cooldown": 2,
        "ranks": [ { "cooldown": 1 } ],
        "effects": [ { "kind": "damage", "element": "earth", "min": 6, "max": 10 }, { "kind": "pull", "cells": 3 } ] },
      { "key": "martyr_oath", "name": "Martyr's Oath", "ap": 2, "min": 0, "max": 0, "los": false, "cooldown": 4,
        "ranks": [ { "cooldown": 3 } ],
        "effects": [ { "kind": "self_damage", "min": 8 }, { "kind": "status", "status": "damagebuff", "mag": 35, "turns": 2 } ] },
      { "key": "iron_will", "name": "Iron Will", "ap": 2, "min": 0, "max": 0, "los": false, "cooldown": 4,
        "ranks": [ { "cooldown": 3 } ],
        "effects": [ { "kind": "status", "status": "damagebuff", "mag": 30, "turns": 2 } ] },
      { "key": "sunder", "name": "Sunder", "ap": 4, "min": 1, "max": 1, "crit": 25, "los": true, "cooldown": 2,
        "ranks": [ { "ap": 3 }, { "cooldown": 1 } ],
        "effects": [ { "kind": "damage", "element": "fire", "min": 14, "max": 20 }, { "kind": "status", "status": "vulnerable", "mag": 20, "turns": 2 } ] },
      { "key": "war_cry", "name": "War Cry", "ap": 3, "min": 1, "max": 3, "crit": 30, "los": true, "cooldown": 3,
        "ranks": [ { "max": 4 }, { "cooldown": 2 } ],
        "effects": [ { "kind": "damage", "element": "fire", "min": 8, "max": 12 }, { "kind": "status", "status": "damagedebuff", "mag": 25, "turns": 2 } ] },
      { "key": "wraith_wail", "name": "Wraith Wail", "ap": 3, "min": 3, "max": 7, "crit": 35, "los": true,
        "effects": [ { "kind": "damage", "element": "air", "min": 11, "max": 15 } ] },
      { "key": "wraith_leash", "name": "Wraith Leash", "ap": 3, "min": 2, "max": 5, "crit": 32, "los": true, "cooldown": 2,
        "effects": [ { "kind": "damage", "element": "air", "min": 6, "max": 9 }, { "kind": "steal_range", "cells": 2, "turns": 2 } ] },
      { "key": "ghoul_rend", "name": "Ghoul Rend", "ap": 3, "min": 1, "max": 1, "crit": 30, "los": true,
        "effects": [ { "kind": "lifesteal", "element": "earth", "min": 8, "max": 12 } ] },
      { "key": "marrow_rot", "name": "Marrow Rot", "ap": 3, "min": 2, "max": 6, "crit": 35, "los": true, "cooldown": 3,
        "effects": [ { "kind": "damage", "element": "water", "min": 6, "max": 10 }, { "kind": "status", "status": "poison", "mag": 3, "turns": 2 } ] },
      { "key": "brute_hurl", "name": "Hurl", "ap": 4, "min": 1, "max": 1, "crit": 30, "los": true,
      ...
      { "key": "sexton_smash", "name": "Sexton's Toll", "ap": 5, "min": 1, "max": 1, "crit": 25, "los": true, "cooldown": 2,
        "effects": [ { "kind": "damage", "element": "earth", "min": 18, "max": 26 }, { "kind": "push", "cells": 2 } ] },
      { "key": "sexton_hook", "name": "Gravedigger's Hook", "ap": 4, "min": 2, "max": 5, "crit": 30, "los": true, "cooldown": 1,
        "effects": [ { "kind": "damage", "element": "earth", "min": 8, "max": 12 }, { "kind": "pull", "cells": 2 } ] },
      { "key": "seize", "name": "Seize", "ap": 3, "min": 1, "max": 1, "crit": 32, "los": true, "cooldown": 1,
      ...
      { "key": "crippling_arrow", "name": "Crippling Arrow", "ap": 2, "min": 3, "max": 7, "crit": 30, "los": true, "cooldown": 1,
        "ranks": [ { "max": 8 }, { "cooldown": 0, "crit": 22 } ],
        "effects": [ { "kind": "damage", "element": "air", "min": 6, "max": 10 }, { "kind": "status", "status": "mpdrain", "mag": 1, "turns": 1 } ] },
      { "key": "flashfire", "name": "Flashfire", "ap": 3, "min": 1, "max": 2, "crit": 28, "los": true, "cooldown": 1,
        "ranks": [ { "ap": 2, "crit": 20 } ],
      ...
      { "key": "blink", "name": "Blink", "ap": 2, "min": 1, "max": 2, "los": false, "cooldown": 30, "targetsGround": true,
        "effects": [ { "kind": "teleport" } ] },
      { "key": "deadeye", "name": "Deadeye", "ap": 5, "min": 5, "max": 8, "crit": 22, "critFail": 50, "los": true, "cooldown": 1,
        "ranks": [ { "max": 9 }, { "cooldown": 0, "crit": 16 } ],
        "effects": [ { "kind": "damage", "element": "air", "min": 16, "max": 22 } ] },
      { "key": "blood_price", "name": "Blood Price", "ap": 4, "min": 1, "max": 1, "crit": 25, "critFail": 50, "los": true, "cooldown": 1,
        "ranks": [ { "cooldown": 0, "crit": 18 } ],
    ...
    [
      ...
      { "name": "Piper's Mend",  "skill": "mend_self",       "blurb": "The piper's mercy: bind your own wounds mid-fight." },
      { "name": "Piper's Call",  "skill": "piper_call",      "blurb": "The piper's summons: a grave mite answers." },
